...
create_schema <- function(overwrite = F) {
  ...
  if (nrow(db_tables) > 0 & overwrite == F) {
    ...
    dbSendQuery(
      ...
      cci_fitness_method float DEFAULT NULL,
      cci_rank_fitness_method integer DEFAULT NULL,
      cci_reflections_method float DEFAULT NULL,
      cci_rank_reflections_method integer DEFAULT NULL,
      cci_eigenvalues_method float DEFAULT NULL,
      cci_rank_eigenvalues_method integer DEFAULT NULL,
